...
| [BUILD_LOG.md](../BUILD_LOG.md) | 历史审查/过程记录；不作当前库存 |
| [CAREER_CARDS.md](../CAREER_CARDS.md) | 重点职责核对并整理；状态页引用 |
...
| [CAREER_MAP_LOCAL_VIEWER.md](../CAREER_MAP_LOCAL_VIEWER.md) | 筛选/试用说明；不作职业覆盖统计 |
| [CAREER_MAP_TAXONOMY.md](../CAREER_MAP_TAXONOMY.md) | 筛选/试用说明；不作职业覆盖统计 |
...
| [PRODUCT.md](../PRODUCT.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
...
| [SCHEMA_COMPATIBILITY.md](../SCHEMA_COMPATIBILITY.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
...
| [WORKFLOW.md](../WORKFLOW.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
| [action_quality_gate.md](../action_quality_gate.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
| [audits/action4_reuse_map.md](../audits/action4_reuse_map.md) | 历史审查/过程记录；不作当前库存 |
| [audits/action5_role_pack_gap.md](../audits/action5_role_pack_gap.md) | 历史审查/过程记录；不作当前库存 |
...
| [llm-first-conversation-poc.md](../llm-first-conversation-poc.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
| [research/adjacent-career-job-source-inventory-2026-08-17.md](../research/adjacent-career-job-source-inventory-2026-08-17.md) | 有日期的研究或工具方案；不是当前职业状态 |
...
| [research/healthcare-ai-product-manager-jobs-2026-08-17.md](../research/healthcare-ai-product-manager-jobs-2026-08-17.md) | 有日期的研究或工具方案；不是当前职业状态 |
...
| [wave2_launch_templates.md](../wave2_launch_templates.md) | 产品、实现、验证或版本化方案；扫描状态表述及链接，未全量复验行为 |
