# China Career Coverage Matrix v1

**Status:** current planning source for China-oriented medical-background
career coverage. This matrix recommends product coverage paths; it does not
create a Role Pack, routing target, or claim that any listed role is currently
available without the applicable runtime support.
...
for likely frequency among medical-background career changers in China; they
are **not** labor-market share, vacancy volume, salary, or hiring-probability
statistics. Evidence counts are qualitative: `established` means an existing
canonical Pack; `multi-JD` means multiple reviewed employer JD signals; and
`scoping` means the direction needs a dedicated China JD corpus before a
graduation decision.

| Career | Demand | Medical fit | JD stability / specificity | Stable core and transferable evidence | Hard gaps / high-risk mapping | Recommended tier | Confidence | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Academic / PhD | high | high | high / high | research design, literature, analysis, manuscripts | participant work is not independent research ownership | A — Deep | high | established |
| Clinical Research / CRA | high | high | high / high | protocol execution support, GCP, CRF, source-data and query follow-up | coordination is not site, trial, or project ownership | A — Deep | high | established |
| Medical Affairs / MSL | high | high | high / high | scientific exchange, literature interpretation, internal medical support | internal presentation is not external KOL ownership | A — Deep | high | established |
...
| Healthcare Consulting | medium | medium | low / medium | problem structuring, research, analysis, presentation | not client delivery, workstream leadership, or commercial recommendation ownership | C — JD-driven Generalist | high | multi-JD |
| Commercial / Business Analytics | medium | medium | low-medium / low-medium | analysis, reporting, data quality | not revenue, forecasting, customer, or commercial decision ownership | C — JD-driven Generalist | high | multi-JD |
| Healthcare / Project Operations | medium | medium | low / medium | documentation, tracking, coordination support | not program, process, budget, vendor, or people ownership | C — JD-driven Generalist | high | multi-JD |
| Medical Sales / Commercial | medium | medium | low / medium | clinical communication and evidence literacy | not quota, account, customer, or territory ownership | C — JD-driven Generalist | medium | scoping |
...
- **JD-driven path:** Market Access, Product, Consulting, Commercial Analytics,
  Healthcare/Project Operations, and Medical Sales should retain a concrete JD
