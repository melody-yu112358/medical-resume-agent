...
它有三种使用方式：从零整理一段零散经历；选中已有简历的一到三条做局部润色；在内容确认后生成可打印的单栏 HTML 简历。完整生成模式会提供稳妥、专业和高竞争力三档版本，默认推荐信息密集的专业版。它不应用于虚构实验、升级个人责任，或把岗位要求写成个人经历。
...
对于证据充分的代表经历，Skill 会从背景、目标、个人职责、流程、方法、工具、质控、判断、协作和产出中选择真实存在的维度，通常形成 5–9 条各自证明不同能力的内容；较小经历通常为 3–6 条。事实不足时减少条目并继续追问，不为了铺满页面制造内容。
