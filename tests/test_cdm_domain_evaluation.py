...
def test_cdm_domain_evaluation_is_evidence_bound_and_useful():
    cases = json.loads((Path(__file__).parents[1] / "docs/research/role-validation/cdm/domain-evaluation-v1.json").read_text(encoding="utf-8"))["cases"]
