...
def test_current_track_dry_run_reflects_evidence_driven_next_actions():
    ...
    assert payloads["medical_device_clinical_application_specialist"]["assigned_agent"] == "researcher"
    assert payloads["medical_device_clinical_application_specialist"]["next_action"] == "collect_more_jds"
